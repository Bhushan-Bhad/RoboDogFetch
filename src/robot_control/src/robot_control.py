...
sys.path.append('src/unitree_legged_sdk/lib/python/amd64')
sdk = ctypes.CDLL('src/unitree_legged_sdk/lib/python/amd64/robot_interface.cpython-38-x86_64-linux-gnu.so')

class RobotControl:
    def __init__(self):
        self.sub = rospy.Subscriber('planned_path/output', String, self.callback)
